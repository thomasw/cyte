 ...
 *		<engineincpear>
 *
 *	PEAR files may be included in the classes folder inside the engine folder and not installed on the system
 *
**/
class locator_engineincpear implements locator  {
	protected $base;
	
	public function __construct()  {
		global $template_conf;
        $this->base = $template_conf['engine_path'].'classes/';
    }
